...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "rounded-lg! border-2 border-border bg-main p-3 font-heading shadow-shadow",
        className,
      )}
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-main-foreground rounded-lg w-9 font-base text-[0.8rem]",
        ...
        cell: cn(
          ...
          props.mode === "range"
            ...
            : "[&:has([aria-selected])]:rounded-lg [&:has([aria-selected])]:bg-black/50",
        ),
        day: cn(
          buttonVariants({ variant: "noShadow" }),
        ...
        day_range_start:
          "day-range-start aria-selected:bg-black! aria-selected:text-white rounded-lg",
        day_range_end:
          "day-range-end aria-selected:bg-black! aria-selected:text-white rounded-lg",
        day_selected: "bg-black! text-white! rounded-lg",
        day_today: "bg-secondary-background text-foreground!",
        day_outside:
          "day-outside text-main-foreground opacity-50 aria-selected:bg-none",
        day_disabled: "text-main-foreground opacity-50 rounded-lg",
