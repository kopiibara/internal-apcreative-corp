  ...
  return (
    <ScrollArea className="w-full pb-2" scrollbars="horizontal">
      ...
      <Select value={selectedBrandFilter} onValueChange={setSelectedBrandFilter}>
        <SelectTrigger className="h-9 min-w-[150px] md:min-w-[160px] text-card-foreground">
      ...
      >
        <SelectTrigger className="h-9 min-w-[150px] md:min-w-[180px] text-card-foreground">
      ...
      >
        <SelectTrigger className="h-9 min-w-[150px] md:min-w-[170px] text-card-foreground">
      ...
      <Button
        ...
        variant="outline"
        size="sm"
        className="h-9 whitespace-nowrap text-card-foreground"
