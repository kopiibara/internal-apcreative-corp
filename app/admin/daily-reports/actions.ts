...
import type { DailyReportData } from "@/lib/daily-report-types"
import { getDailyReportData } from "@/lib/daily-reports"
...
): Promise<DailyReportActionResult<Awaited<ReturnType<typeof getDailyReportData>>>> {
